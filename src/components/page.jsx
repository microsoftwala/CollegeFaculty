...
const Page = () => {
  ...
  return (
    <div className="w-full h-screen mb-32">
      ...
      <footer
        className={`fixed bottom-0 left-0 mb-2 w-full ${show ? "blur-sm" : ""}`}
      >
        <div className="width-full h-0.5 bg-zinc-400 ml-1 mr-1"></div>
...
export default Page;
>>>>>>> d71966b045d1fbfab3f31f35869b13b0ade58849
